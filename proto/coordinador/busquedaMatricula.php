...
if ($control == 1) {
    ...
    while ($datos = mysql_fetch_array($ra)) {
        echo "<strong >".$datos["nombre"]."&nbsp;".$datos["apellido"]."<strong/>";
    ...
    echo "<strong style='float: left' >" . $_SESSION["matricula"] . "<strong/>";
} else if ($control == 3) {
    echo "<strong style='float: left' >" . $_SESSION["semestre"] . "<strong/>";
}
?>
